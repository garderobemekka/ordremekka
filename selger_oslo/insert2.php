...
if($fileSize == 0){
   $query = "INSERT INTO `ordre`(`ordrenr`, `kundenr`, `kundenavn`, `kundetelefon`, `kundeepost`, `selger`, `avdeling`, `leveringskode`, `forskudd`, `trondheim`, `spesial`, `ekspress`, `kommentartilordre`, `kommentartilproduksjon`, `status`, `ordrevedlegg`, `datoopprettet`) VALUES('$ordrenr', '$kundenr', '$kundenavn', '$kundetelefon', '$kundeepost', '$selger', '$avdeling', '$leveringskode', '$forskudd', '$trondheim', '$spesial', '$ekspress', '$kommentartilordre', '$kommentartilproduksjon', '$status', NULL, '$datoopprettet')";
