...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                <h2>MOTTATT AVDELING- STOR OSLO</h2>
            </div>
                ...
                $query = "SELECT * FROM ordre where (avdeling = 1) AND (status='Mottatt Avdeling')  ORDER BY `ordre`.`ekspress` ASC, `ordre`.`spesial` ASC, `ordre`.`datosendtprod` ASC";
