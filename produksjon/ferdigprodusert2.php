...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                <h2>PRODUKSJONS LINJE - FERDIG PRODUSERT - TRONDHEIM</h2>
            </div>
                ...
                $query = "SELECT * FROM ordre where (avdeling = 2) AND (status='Ferdig Produsert')  ORDER BY `ordre`.`ekspress` ASC, `ordre`.`spesial` ASC, `ordre`.`datosendtprod` ASC";
