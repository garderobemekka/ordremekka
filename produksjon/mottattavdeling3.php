...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                ...
                <h2>MOTTATT AVDELING- FREDRIKSTAD</h2>
            </div>
                ...
                $query = "SELECT * FROM ordre where (avdeling = 3) AND (status='Mottatt Avdeling')  ORDER BY `ordre`.`ekspress` ASC, `ordre`.`spesial` ASC, `ordre`.`datosendtprod` ASC";
