...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                <h2>MOTTATT AVDELING- TRONDHEIM</h2>
            </div>
                ...
                $query = "SELECT * FROM ordre where (avdeling = 2) AND (status='Mottatt Avdeling')  ORDER BY `ordre`.`ekspress` ASC, `ordre`.`spesial` ASC, `ordre`.`datosendtprod` ASC";
