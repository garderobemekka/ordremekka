    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_ferdigprodusert1.php" method="POST">
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                ...
                <h2>PRODUKSJONS LINJE - STOR OSLO</h2>
            </div>
                ...
                $query = "SELECT * FROM ordre where (avdeling = 1) AND (status='Sendt Prod Linje')  ORDER BY `ordre`.`ekspress` ASC, `ordre`.`spesial` ASC, `ordre`.`datosendtprod` ASC";
