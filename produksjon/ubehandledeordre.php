...
$query = "SELECT * FROM ordre where status = 'Sendt Prod Linje' ORDER BY `ordre`.`datosendtprodlinja` ASC, `ordre`.`avdeling` ASC'";
 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> MERKE ORDRE FERDIG PRODUSERT  </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_ferdigprodusert.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kundenavn" id="kundenavn" placeholder="Kunde Navn" readonly>
                            ...
                            <input type="text" name="status" value="Ferdig Produsert" 	readonly>
                            <input type='text' value='<?php echo $date ?>' id='datoferdigprodusert' name='datoferdigprodusert' readonly><br>
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                ...
                $query = "SELECT * FROM `ordre` where status = 'Sendt Prod Linje' ORDER BY `ordre`.`datosendtprodlinja` ASC;";
            ...
            ?>
                        ...
                        <tbody class="tbody1">
                            <tr><center>
                                ...
                                <td> <center><?php if($row['avdeling'] == '1'){ 
                                    echo 'STOR OSLO'; 
                                    } else if($row['avdeling'] == '2'){ 
                                        echo 'TRD'; } else if($row['avdeling'] == '3'){ 
                                            echo 'FREDRIKSTAD';  } ?> </center></td>
                                <?php 
                                // ENDRER FARGEN HVOR DET ER JA PÅ SPESIAL ORDRE
                                if($row['spesial'] == 'JA'){
                                    echo '<td bgcolor=#606060><font color="#ffffff"> <center>'  .$row['datosendtbestillingspesial']. '</center></td></font>';
                                }else{
