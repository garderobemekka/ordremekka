...
$avdeling = $row['avdelingsnr'];


include_once('../conn.php'); 
$query = "SELECT * FROM ordre where avdeling = '".$avdeling."' and (status = 'Sendt til Monteringsleder')";
...
$sql = "SELECT * FROM `google_auth` where usertype = '6' or usertype = '7'"; // HENTER BRUKERTYPE 6 og 7 (Monteringsleder OG montør)
 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">VIDERESEND TIL MONTØR</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_sendtmontor.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="num" name="kundenavn" id="kundenavn" placeholder="Kunde Nr" readonly>    <br>
                        <label> Kunde Telefon Nr</label><br>
                        <input type="num" name="kundetelefon" id="kundetelefon" placeholder="Kunde Nr" readonly>    <br>
                        <label> Leveringskode</label><br>
                        <input type="text" name="leveringskode" id="leveringskode" placeholder="Leveringskode" readonly>  
                        <label> Avdeling</label><br>
                        <input type="text" name="avdeling" id="avdeling" placeholder="Avdeling" readonly>
                    </div>
                        <label>Velg Montør:
                            <!---------- MONTØR VELGER START ------------------->
                            <select name="montor" id="montor" class="form-control" selected="test" required>
            
            <?php
            while ($montor = mysqli_fetch_array(
            $all_categories,MYSQLI_ASSOC)):;
            ?>
                <option value="<?php echo $montor['username'];
                ?>"  >
                    <?php echo $montor['username']; 
            ...
            ?>
                    ...
                    <br>
                            ...
                            <input type="text" name="status" value="Sendt til Montør" 	readonly>
                            <input type='text' value="<?php echo $date; ?>" id='datosendtmontor' name='datosendtmontor' readonly><br>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h2>MONTERINGSORDRE - ordrer som er klare for montering</h2>
            </div>
            <div align="right">
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where (avdeling = '1' and status = 'Sendt til Monteringsleder') or (avdeling = '3' and status = 'Sendt til Monteringsleder')";
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                                ...
                                <td> <center><font size=3><?php echo $row['leveringskode']; ?> </center></td></font>
                                <td> <center><?php 
                                if($row['avdeling'] == '1'){ 
                                    echo "Stor Oslo"; }
                                else if($row['avdeling'] == '2'){
                                    echo "Trondheim"; } 
                                else if($row['avdeling'] == '3'){ 
                                    echo "Fredrikstad"; 
                                    } ?> </center></td>
                                ...
                                <td> <center><?php echo $row['datoferdigprodusert']; ?> </center></td>
