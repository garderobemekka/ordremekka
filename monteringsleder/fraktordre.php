...
$query = "SELECT * FROM ordre where avdeling = '".$avdeling."' and (status = 'Sendt til Frakt')";
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                <h2>FRAKTORDRE - ordrer som er klare for frakt</h2>
            </div>
            <div align="right">
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where (avdeling = '1' and status = 'Sendt til Frakt' and leveringskode = 'FF') or (avdeling = '1' and status = 'Sendt til Frakt' and leveringskode = 'FFI') or (avdeling = '1' and status = 'Sendt til Frakt' and leveringskode = 'FI') or (avdeling = '3' and status = 'Sendt til Frakt' and leveringskode = 'FF') or (avdeling = '3' and status = 'Sendt til Frakt' and leveringskode = 'FFI') or (avdeling = '3' and status = 'Sendt til Frakt' and leveringskode = 'FI') ORDER BY `datosendtprod` ASC";
