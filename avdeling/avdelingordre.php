...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where avdeling = '".$avdelingsnr."'";
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                            <td> <center><font size=2><a href="<?php echo $baseurl; ?>/ordreinfo.php?ordreinfo=<?php echo $row['ordrenr'] ?>"><?php echo $row['ordrenr']; ?> </a></font></center></td></div>
