...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid" >
               ...
               $query = "SELECT * FROM ordre where avdeling = '".$avdelingsnr."' and (status = 'Mottatt Avdeling' and leveringskode = 'FF') or (status = 'Mottatt Avdeling' and Leveringskode = 'FFI') or (status = 'Mottatt Avdeling' and Leveringskode = 'FI')  ORDER BY `datosendtprod` ASC";
