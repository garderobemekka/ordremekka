...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid" >
            ...
            <div class="container-fluid" >
               ...
               $query = "SELECT * FROM ordre where avdeling = '".$avdelingsnr."' and (status = 'Mottatt Avdeling' and leveringskode = 'HF') or (status = 'Mottatt Avdeling' and Leveringskode = 'HFI') or (status = 'Mottatt Avdeling' and Leveringskode = 'HI')  ORDER BY `datosendtprod` ASC";
