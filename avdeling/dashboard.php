...
<div class="container-fluid2">
  ...
  <div class="col-gap infobox">
    <div class="topptekst">AVDELING OPPGAVER:</div><font size="3px">
    <?php if($totaleubehandledeavd > 0){echo "Ubehandlede ordre antall:  <font color='red'>  $totaleubehandledeavd </font><br>";}else { } ?>
    <?php if($totalesendeforskuddfakturaavd > 0){echo "Sende Forskudd Faktura:  <font color='red'>  $totalesendeforskuddfakturaavd </font><br>";}else { } ?>
    <?php if($totalehosproduksjonsattpaventavd > 0){echo "Satt på vent:  <font color='red'>  $totalehosproduksjonsattpaventavd </font><br>";}else { } ?>
    <?php if($totaleforskuddfakturabetaltavd > 0){echo "Forskudd Faktura Betalt:  <font color='red'>  $totaleforskuddfakturabetaltavd </font><br>";}else { } ?>
    <?php if($totaleferdigprodusertavd > 0){echo "Ferdig produsert:  <font color='red'>  $totaleferdigprodusertavd </font><br>";}else { } ?>
    <?php if($totalemottattavdelingavd > 0){echo "Mottatt avdeling:  <font color='red'>  $totalemottattavdelingavd </font><br>";}else { } ?>
    </div></font>
    
    
    <div class="col infobox">
    <div class="topptekst">STATISITKK ?:</div>
    <br><center><h4><a href="mineordre.php" class="dashboardlink"><?php echo "TOTALT ORDRE $totalordreavd"; ?></h4></center></a>
    <br><center><h4><a href="mineordre.php" class="dashboardlink"><?php echo "TOTALT FULLFØRT $totalefullfortavd"; ?></h4></center></a>
    </div>
  </div>
</div>
<br>
<div class="container-linje ">
  ...
  <div class="row"> 
    <div class="col"> <br>
    <center><h1><a href="ubehandledeordre.php" class="dashboardlink"><?php if($totaleubehandledeavd  > 0){ echo "<font color='red'>$totaleubehandledeavd</font>";}else{ echo $totaleubehandledeavd; } ?></h1></center></a>
    </div>
    <div class="col"> <br>
    <center><h1><a href="ubehandledeordre_faktura.php" class="dashboardlink"><?php if($totalesendeforskuddfakturaavd  > 0){ echo "<font color='red'>$totalesendeforskuddfakturaavd</font>";}else{ echo $totalesendeforskuddfakturaavd; }; ?></h1></center></a>
    </div>
    <div class="col"> <br>
    <center><h1><a href="ubehandledeordre_hosfaktura.php" class="dashboardlink"><?php echo $totalehosfakturaavd; ?></h1></center></a>
    </div>
    <div class="col"> <br>
    <center><h1><a href="ubehandledeordre.php" class="dashboardlink"><?php if($totaleforskuddfakturabetaltavd > 0){ echo "<font color='red'>$totaleforskuddfakturabetaltavd</font>";}else{ echo $totaleforskuddfakturabetaltavd;} ?></h1></center></a>
    </div>
  </div>
</div>
<br>
<div class="container-linje">
  ...
  <div class="row"> 
    <div class="col"> <br>
    <center><h1><a href="hosproduksjon.php" class="dashboardlink"><?php echo $totalehosproduksjonavd; ?></h1></center></a>
    </div>
    <div class="col"> <br>
    <center><h1><a href="hosproduksjon_pavent.php" class="dashboardlink"><?php if($totalehosproduksjonsattpaventavd > 0){ echo "<font color='red'>$totalehosproduksjonsattpaventavd</font>";}else{ echo $totalehosproduksjonsattpaventavd;} ?></h1></center></a>
    </div>
    <div class="col"> <br>
    <center><h1><?php echo $totalesendtprodlinjeavd; ?></h1></center>
    </div>
    <div class="col"> <br>
    <center><h1><a href="ferdigprodusert.php" class="dashboardlink"><?php if($totaleferdigprodusertavd > 0){ echo "<font color='red'>$totaleferdigprodusertavd</font>";}else{echo $totaleferdigprodusertavd;} ?></h1></center></a>
    </div>
