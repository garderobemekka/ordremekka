...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid" >
                <h2>AVDELING - UBEHANDLEDE ORDRER</h2>
            </div>
            ...
            <div class="container-fluid" >
                ...
                $query = "SELECT * FROM ordre where (avdeling = '".$avdelingsnr."' and status = 'Ubehandlet')  ORDER BY `datoopprettet` ASC";
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                            <td> <center><font size=3><a href="<?php echo $baseurl; ?>/ordreinfo.php?ordreinfo=<?php echo $row['ordrenr'] ?>"><?php echo $row['ordrenr']; ?> </a></center></font></td></div>
