...
$query = "SELECT * FROM ordre where selger = '".$username."' and (status = 'Ubehandlet') or (status ='Faktura Betalt'";
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="card-body" align="right"></div>
            <div class="card">
                <h2>AVDELING - SENDT TIL PRODUKSJON - SATT PÅ VENT</h2>
            </div>
            <div align="right">
               ...
               $query = "SELECT * FROM ordre where avdeling = '".$avdelingsnr."' and (status = 'Satt På Vent')  ORDER BY `datosendtprod` ASC";
