...
$query = "SELECT * FROM ordre where avdeling = '".$avdelingsnr."' and (status = 'Ubehandlet') or (status ='Faktura Betalt'";
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <h2>MOTTATT AVDELING<br><font size="3px">(Mine ordrer som er mottatt avdeling)</font></h2>
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where avdeling = '".$avdelingsnr."' and (status = 'Mottatt Avdeling')  ORDER BY `datosendtprod` ASC";
