...
$query = "SELECT * FROM ordre where (avdeling = '".$avdelingsnr."' and status = 'Sendt Forskudd Regnskap') or (avdeling = '".$avdelingsnr."' and status = 'Forskudd Faktura Sendt')  ORDER BY `datoopprettet` ASC";
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid" >
                <h2>AVDELING - FORSKUDD FAKTURA ORDRE - Ordrer som ligger hos regnskap - venter på betaling </h2>
            ...
            <div class="container-fluid" >
                ...
                $query = "SELECT * FROM ordre where (avdeling = '".$avdelingsnr."' and status = 'Sendt Forskudd Regnskap') or (avdeling = '".$avdelingsnr."' and status = 'Forskudd Faktura Sendt')  ";
                $query_run = mysqli_query($connection, $query);
                $ordrenr = $row["ordrenr"];
