...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                <h2>MINE FRAKTEORDRE - ordrer som er klare for å fraktes</h2>
            </div>
            <div align="right">
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where selger = '".$firstname."' and (status = 'Mottatt Avdeling') and (leveringskode = 'FF' or Leveringskode = 'FFI' or Leveringskode = 'FI')  ORDER BY `datosendtprod` ASC";
