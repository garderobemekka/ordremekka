 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">MONTERING UTFØRT </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_monteringferdig.php" method="POST">

                    <div class="modal-body">
                    <div class="form-group"><div class="row">
                    <label>ORDRE NR:</label><input type="num" name="ordrenr1" id="ordrenr1" placeholder="Ordre Nr" ></label><input type="text" name="montor" id="montor" placeholder="Montør" >
                        <div class="col infobox"><label> Kunde Nr</label><br>
                        <input type="num" name="kundenr" id="kundenr" placeholder="Kunde Nr" readonly>  <br> 
                        <label> Kunde Navn</label><br>
                        <input type="num" name="kundenavn" id="kundenavn" placeholder="Kunde Navn" readonly>   <br> 
                        <label> Kunde Telefon</label><br>
                        <input type="num" name="kundetelefon" id="kundetelefon" placeholder="Kunde Telefon" readonly>  </div>   <br>
                        <div class="col infobox">
                        <label> Leveringskode</label><br>
                        <input type="num" name="leveringskode" id="leveringskode" placeholder="Leveringskode" readonly> <br> 
                        <label> Dato for montering</label><br>
                        <input type="date" name="datomontering" id="datomontering" placeholder="Dato for montering" required><br>  
                        <label> Status blir endret til:</label><br>
                        <input type="text" name="status" id="status" value="Montering Utført" 	readonly>
                        </div>    
                    </div></div>
                    
                    <div class="form-group"><div class="row">
                        <div class="col monteringbox">
                        <label>Antall Montering elementer:</label><br>
                        <input type="num" name="monteringselementer" id="monteringselementer" placeholder="Montering Elemtenter" > 
                        <br><br>
                        <label>Antall Kutt elementer:</label><br>
                        <input type="num" name="kuttelementer" id="kuttelementer" placeholder="Kutte Elementer" > 
                        <br><br>
                        <label>Antall Frakt elementer:</label><br>
                        <input type="num" name="fraktelementer" id="fraktelementer" placeholder="Frakt elementer" > 
                        <br><br>
                        <label>Antall etasje tillegg:</label><br>
                        <input type="num" name="etasjetillegg" id="etasjetillegg" placeholder="Etasje tillegg" > 
                        </div>
                        <div class="col monteringbox">
                            <label>Del levering</label><br>
                            <input type="checkbox" name="dellevert" id="dellevert"><br>
                            <label>Kommentar til del levering</label>
                            <textarea name="kommentardellevering" id="kommentardellevering">
                                            </textarea>
                    ...
                    <br>
                    <input type="file" name="monteringbilder" id="monteringbilder" > 
                </div></div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal"> LUKK </button>
                        <button type="submit" name="updatedata2" class="btn btn-primary">FULLFØR</button>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <h2>MONTERINGSORDRE - Ordre hvor montering er avtalt</h2>
            </div>
            <div align="right">
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where selger = '".$firstname."' and (status = 'Montering Avtalt') ORDER BY `datosendtprod` ASC";
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                            <td> <center><font size=3><a href="<?php $baseurl = "http://localhost/ordremekka/"; echo $baseurl; ?>ordreinfo.php?ordreinfo=<?php echo $row['ordrenr'] ?>"><?php echo $row['ordrenr']; ?> </a></center></td></div></font>
                                ...
                                <td> <center><?php echo $row['montor']; ?></center> </td>
                                ...
                                <td> <center><?php echo $row['datomontering']; ?> </center></td>
                                ...
                                <td><center><button type="button" class="btn btn-info btn-sm edit2btn"> FULLFØRE </button></td></center>
