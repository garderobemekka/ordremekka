 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">BOOK MONTERING</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_datomontering.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="datomontering" id="datomontering" placeholder="Dato for montering" required>  
                    </div><br>
                            <label> Status blir endret til:</label><br>
                            <input type="text" name="status" value="Montering Avtalt" 	readonly>
                            <br>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div align="right">
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where montor = '".$firstname."' and (status = 'Sendt til Montør') ORDER BY `datosendtprod` ASC";
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                                ...
                                <td> <center><a href="https://www.google.no/maps/place/<?php echo $row['kundeadresse']; ?>,+<?php echo $row['kundepostnr']; ?>+<?php echo $row['kundepoststed']; ?> " target="new">Adresse</a></center> </td>
                                ...
                                <td><center><button type="button" class="btn btn-info btn-sm edit2btn"> BOOK </button></td></center>
