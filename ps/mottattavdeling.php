...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <h2>MOTTATT AVDELING STOR OSLO <br><font size="3px">(Ordrer som er mottatt avdeling)</font></h2>
               ...
               include_once('../conn.php');
                ...
                $query = "SELECT * FROM ordre where avdeling = '1' and (status = 'Mottatt Avdeling')  ORDER BY `datosendtprod` ASC";
