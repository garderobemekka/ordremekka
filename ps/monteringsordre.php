...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid" >
                <h2>AVDELING - MONTERINGSORDRE</h2>
            ...
            <div class="container-fluid" >
               ...
               $query = "SELECT * FROM ordre where avdeling = '".$avdelingsnr."' and (status = 'Mottatt Avdeling' and leveringskode = 'MF') or (status = 'Mottatt Avdeling' and Leveringskode = 'MFI') or (status = 'Mottatt Avdeling' and Leveringskode = 'MI')  ORDER BY `datosendtprod` ASC";
