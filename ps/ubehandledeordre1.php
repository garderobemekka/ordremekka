...
<body class="a2z-wrapper">
 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="spesialmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_spesialbestilling1.php" method="POST">
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="update_endrestatus1.php" method="POST">
    ...
    <div class="container-fluid">
                <h2>UBEHANDLEDE ORDRER - STOR OSLO</h2>
            </div>
         
                    <?php
               include_once('../conn.php'); 

                $query = "SELECT * FROM ordre where (avdeling = '1' AND status='Sendt Produksjon') or (avdeling = '1' AND status ='Satt på vent') ORDER BY `ordre`.`ekspress` ASC, `ordre`.`spesial` ASC, `ordre`.`datosendtprod` ASC";
