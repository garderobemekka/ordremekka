    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="s_update_mottattavdeling.php" method="POST">
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid" >
               ...
               $query = "SELECT * FROM ordre where (avdeling = '".$avdelingsnr."' and status = 'Mottatt Avdeling' and leveringskode = 'FF') or (avdeling = '".$avdelingsnr."' and status = 'Mottatt Avdeling' and Leveringskode = 'FFI') or (avdeling = '".$avdelingsnr."' and status = 'Mottatt Avdeling' and Leveringskode = 'FI')  ORDER BY `datosendtprod` ASC";
