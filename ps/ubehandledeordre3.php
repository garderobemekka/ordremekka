...
<body class="a2z-wrapper">
 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="spesialmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_spesialbestilling3.php" method="POST">
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="update_sendprodlinja3.php" method="POST">
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="update_endrestatus3.php" method="POST">
    ...
    <div class="container-fluid">
                ...
                <h2>UBEHANDLEDE ORDRER - FREDRIKSTAD</h2>
            </div>
         
                    <?php
               include_once('../conn.php'); 

                $query = "SELECT * FROM ordre where (avdeling = 3) AND (status='Sendt Produksjon') or (avdeling = 3) AND (status ='Satt på vent') ORDER BY `ordre`.`ekspress` ASC, `ordre`.`spesial` ASC, `ordre`.`datosendtprod` ASC";
            ...
            ?>
                        ...
                        <tbody class="tbody1">
                            <tr><center>
                                ...
                                if($row['spesial'] == 'JA'){
                                    if($row['datosendtbestillingspesial'] > 0){
                                        echo '<td bgcolor="#606060"><center>BESTILT</center></td>';
                                    }else{
...
?>
                                ...
                                if(($diff->format('%a')) >= $dager){
                                    ...
                                    echo '<td bgcolor="yellow" > <font color="color="000000"><center>'.$row['datosendtprod'].' </font></center></td>';
                                }
                                else{
