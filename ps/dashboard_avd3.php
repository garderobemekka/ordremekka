...
$resultattotaleordreavd = db_query("SELECT COUNT(1) from ordre where avdeling = '3'");
$row2 = mysqli_fetch_array($resultattotaleordreavd);
$totalordreavd = $row2[0];

//resultat antall ordre under behandling - AVDELING
$resulatubehandledeavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Ubehandlet') or (avdeling = '3' and status = 'Forskudd Faktura Betalt')");
...
$resultatsendeforskuddfakturaavd = db_query("SELECT COUNT(1) from ordre where avdeling = '3' and status = 'Forskudd Faktura'");
...
$resultathosfakturaavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Sendt Forskudd Regnskap') or (avdeling = '3' and status = 'Forskudd Faktura Sendt')");
...
$resultatforskuddfakturabetaltavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Forskudd Faktura Betalt') ");
...
$resultathosproduksjonavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Sendt Produksjon') ");
...
$resultathosproduksjonsattpaventavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Satt På Vent') ");
...
$resultatsendtprodlinjeavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Sendt Prod Linje') ");
...
$resultatferdigprodusertavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Ferdig Produsert') ");
...
$resultatmottattavdelingavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Mottatt Avdeling') ");
...
$resultatmottattavdelingfraktavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'FF') or (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'FFI') or (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'FI') ");
...
$resultatmottattavdelinghentingavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'HF') or (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'HFI') or (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'HI') ");
...
$resultatmottattavdelingmonteringavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'MF') or (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'MFI') or (avdeling = '3' and status = 'Mottatt Avdeling' and leveringskode = 'MI') ");
...
$resultatsendthentingavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Klar for Henting')");
...
$resultatsendtmontoravd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Sendt til monteringsleder')");
$row15 = mysqli_fetch_array($resultatsendtmontoravd);
$totalesendtmontoravd = $row15[0];

//resultat antall ordre KLAR FOR FRAKT - AVDELING
$resultatsendtfraktavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Sendt til Frakt')");
$row16 = mysqli_fetch_array($resultatsendtfraktavd);
$totalesendtfraktavd = $row16[0];

//resultat antall ordre MONTERING AVTALT - AVDELING
$resultatmonteringavtaltavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Montering Avtalt')");
...
$resultatmonteringutfortavd = db_query("SELECT COUNT(1) from ordre where (avdeling = '3' and status = 'Montering Utført')");
...
<div class="container-linje-stor">
  ...
  <div class="row"> 
    <div class="col"> <br>
    <center><h1><a href="ubehandledeordre3.php" class="dashboardlink"><?php echo $totalehosproduksjonavd; ?></h1></center></a>
    </div>
    <div class="col"> <br>
    <center><h1><a href="ubehandledeordre3.php" class="dashboardlink"><?php if($totalehosproduksjonsattpaventavd > 0){ echo "<font color='red'>$totalehosproduksjonsattpaventavd</font>";}else{ echo $totalehosproduksjonsattpaventavd;} ?></h1></center></a>
    </div>
    <div class="col"> <br>
    <center><h1><?php echo $totalesendtprodlinjeavd; ?></h1></center>
    </div>
    <div class="col"> <br>
    <center><h1><a href="<?php echo $baseurl; ?>/produksjon/ferdigprodusert3.php" class="dashboardlink"><?php if($totaleferdigprodusertavd > 0){ echo "<font color='red'>$totaleferdigprodusertavd</font>";}else{echo $totaleferdigprodusertavd;} ?></h1></center></a>
    </div>
